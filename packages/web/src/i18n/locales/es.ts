...
export const es: typeof en = {
  ...
  room: {
    ...
    createHeading: 'Crear una sala',
    joinHeading: 'Unirse a una sala',
    nicknameLabel: 'Tu apodo',
    nicknamePlaceholder: 'Cómo te verán los demás',
    codeLabel: 'Código de la sala',
    codeInvalid: 'Un código tiene 4 letras y números, y ninguno es 0, O, 1, I ni L.',
    open: 'Abrir la sala',
    enter: 'Unirme',
    connecting: 'Conectando...',
    back: 'Volver a mi lista',
    notFound: 'No hay ninguna sala con ese código. Revísalo y vuelve a intentarlo.',
    ...
    lobby: {
      ...
      criterion: 'Se compara por',
      heading: 'En la sala',
      count: '{{count}} de {{limit}}',
      creator: 'creó la sala',
      you: 'tú',
      joined: '{{nickname}} entró en la sala.',
      left: '{{nickname}} salió de la sala.',
